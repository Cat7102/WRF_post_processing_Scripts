...
#矢量箭头图数据
ws1=ncfile.variables['U10'][28,:,:]     #箭头图的风速u和v的读取
ws2=ncfile.variables['V10'][28,:,:]
...
#图片保存数据
time=str(Readtime.get_ncfile_time(ncfile,timezone=8)[28])  #读取文件的绘图的时间,timezone是时区
